...
# Getting Started
Clone the repo or download it as zip and run the project in VSCode following installing all dependencies. Then run the project on development server https://localhost:3000
# Technologies Used
